...
Project aiming to provide a Docker image of [Smart-Phase](smart-phase)
...
Eventually this base directory will contain the Docker script for a [Smart-Phase](smart-phase) and
